...
public class MissionControlTest
{
    ...
    public void Given_2_Rovers_Mission_Control_Should_Take_Instructions_And_Move_Them_To_Correct_Positions()
    {
        ...
        rovers[0].CurrentPosition.Direction.Should().Be('N');

        rovers[1].CurrentPosition.XPosition.Should().Be(5);
        rovers[1].CurrentPosition.YPosition.Should().Be(1);
        rovers[1].CurrentPosition.Direction.Should().Be('E');
    }
}